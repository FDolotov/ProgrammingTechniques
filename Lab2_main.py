...
def make(db_file_name, elements_quantity, structure_scheme, structure_data, key):
    ...
    plt.loglog(xlist, ylist1, label = 'Линейный поиск')
    plt.loglog(xlist, ylist2, label = 'Бинарный + сортировка')
    plt.loglog(xlist, ylist3, label = 'Бинарный')
    plt.loglog(xlist, ylist4, label = 'multimap')
...
elements_quantity = [25000, 50000, 75000, 100000, 250000, 500000, 1000000]
